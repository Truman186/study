<template>
  <div class="mainClass">
      ...
      <el-breadcrumb-item>个人详细信息</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <div class="infoForm">
        <el-form class="input" ref="form" :model="form" label-width="80px" >
             ...
             <el-form-item class="input" label="用户名:" style="width:400px">
             <el-input v-model="form.username" readonly></el-input>
             </el-form-item>
           <el-form-item class="input" label="性别:" style="width:400px">
             <el-input v-model="form.sex" readonly></el-input>
             </el-form-item>
              <el-form-item label="生日：">
             <el-col :span="11">
              <el-date-picker type="date" placeholder="选择日期" v-model="form.birth" style="width: 320px;" readonly>     
              </el-date-picker>
                </el-col>
              </el-form-item>
               <el-form-item label="住址:" style="width:400px">
