   ...
   <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
       ...
       <div class="demo-input-suffix">
        ...
        <el-dialog title="课程选择"  :visible.sync="addDiaLog" inline="true" width="50%" @close="addDiaLog=false">
            <el-form :inline="true" :model="addForm"   ref="addFormRef" label-width="70px">
                 ...
                 <el-form-item label="教练名" prop="username" >
                    <el-input v-model="addForm.username" disabled></el-input>
                </el-form-item>
                  <el-form-item label="星期数" prop="weekday">
                    <el-select v-model="addForm.weekday" placeholder="请选择" class="slect1" disabled>
                    <el-option
                 ...
                 <el-form-item label="课时" prop="lesson">
                    <el-input v-model="addForm.lesson" disabled ></el-input>
                </el-form-item>
